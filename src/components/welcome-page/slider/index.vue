<template>
    <swiper class="w-full h-[500px] relative" :modules="modules" :options="swiperOptions" :slides-per-view="1"
        :space-between="0" :autoplay="swiperOptions.autoplay" :navigation="false" :pagination="false"
        effect="coverflow">
